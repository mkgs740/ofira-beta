...
async execute(message,args,client) {
    ...
    .setAuthor("Searching...", "https://media.discordapp.net/attachments/819179592706162749/821694151216857128/Music.gif")
    .setColor("#0000FF")
    ...
    let resultsEmbed = new MessageEmbed()
      ...
      .setColor("#0000FF")
      .setAuthor("Search results!!", "https://media.discordapp.net/attachments/819179592706162749/821694151216857128/Music.gif","http://github.com/saurabh-777")
      .setFooter("Response with your favorite number","https://media.discordapp.net/attachments/819179592706162749/821694151216857128/Music.gif")
