...
execute(message) {
    ...
    if (!queue.playing) {
      ...
      const playembed = new MessageEmbed().setColor("#0000FF")
      .setAuthor(`${message.author.username} resumed the music!`, "https://media.discordapp.net/attachments/819179592706162749/821694151216857128/Music.gif")
      //send the approve
